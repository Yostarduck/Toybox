...
#   define TB_IMGUI_EXPORT
# else
#	if defined(IMGUI_EXPORTS)
#   define TB_IMGUI_EXPORT __declspec(dllexport)
#   else
#     if defined(__MINGW32__)
#       define TB_IMGUI_EXPORT              //Linux systems don't need this
#     else
#       define TB_IMGUI_EXPORT __declspec(dllimport)
#     endif
#   endif
# endif
#endif
...
#   define TB_IMGUI_EXPORT  __attribute__ ((visibility("default")))
# else
#   define TB_IMGUI_EXPORT
# endif
