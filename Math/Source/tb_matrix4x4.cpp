...
Matrix4x4::Matrix4x4(Vector4 vector0,
                     Vector4 vector1,
                     Vector4 vector2,
                     Vector4 vector3)
  : vector0(vector0),
...
Matrix4x4::Translation(const Vector3& Pos) {
  vector3 = Vector4(Pos, 1.0f);
  return *this;
}

Matrix4x4&
Matrix4x4::Move(const Vector3& Move) {
  vector3 += Vector4(Move, 0.0f);
  return *this;
}
...
Matrix4x4
Matrix4x4::InitScale(const Vector3 & Scale) {
  *this = identityMat4x4;
...
Matrix4x4&
Matrix4x4::Rotation(const Vector3& u, float thetaRadians) {
...
Matrix4x4&
Matrix4x4::Reflection(Vector3 NormalOfMirror) {
...
Matrix4x4::operator*(const Matrix4x4& A) const {
  ...
  Vector4 c0(A.vector0.x, A.vector1.x, A.vector2.x, A.vector3.x);
  Vector4 c1(A.vector0.y, A.vector1.y, A.vector2.y, A.vector3.y);
  Vector4 c2(A.vector0.z, A.vector1.z, A.vector2.z, A.vector3.z);
  Vector4 c3(A.vector0.w, A.vector1.w, A.vector2.w, A.vector3.w);
