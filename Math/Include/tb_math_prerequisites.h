...
#   define TB_MATH_EXPORT
# else
#	if defined(MATH_EXPORTS)
#   define TB_MATH_EXPORT __declspec(dllexport)
#   else
#     if defined(__MINGW32__)
#       define TB_MATH_EXPORT              //Linux systems don't need this
#     else
#       define TB_MATH_EXPORT __declspec(dllimport)
#     endif
#   endif
# endif
#endif
...
#   define TB_MATH_EXPORT  __attribute__ ((visibility("default")))
# else
#   define TB_MATH_EXPORT
# endif
