...
#   define TB_CORE_EXPORT
# else
#	if defined(CORE_EXPORTS)
#   define TB_CORE_EXPORT __declspec( dllexport )
#   else
#     if defined( __MINGW32__ )
#       define TB_CORE_EXPORT              //Linux systems don't need this
#     else
#       define TB_CORE_EXPORT __declspec( dllimport )
#     endif
#   endif
# endif
#endif
...
#   define TB_CORE_EXPORT  __attribute__ ((visibility("default")))
# else
#   define TB_CORE_EXPORT
# endif
